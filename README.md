...
<p align="center">
  <img alt="Version: 1.0.0.0" src="Assets/Badges/version.svg" />
...
The current catalog release is **1.0.0.0**. This catalog-metadata correction
matches Jellyfin's four-part assembly version and prevents the stable release
from being repeatedly offered as its own update. The core provider/network,
